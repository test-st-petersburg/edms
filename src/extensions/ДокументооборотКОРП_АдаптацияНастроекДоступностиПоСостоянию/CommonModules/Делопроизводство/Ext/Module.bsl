...
Функция ИТГ_ПолучитьНастройкиСостояний(ДокументОбъект, Пользователь)
	...
	Если ИспользоватьВидыДокументов(ВидДокумента) Тогда 
		...
		ВсеРодителиВидаДокумента = ОбщегоНазначенияДокументооборот.ВсеРодителиЭлемента(ВидДокумента);
		...
		|			ИЛИ НастройкиДоступностиДляВидовДокументов.ВидДокумента В (&ВсеРодителиВидаДокумента))
		|
		|ОБЪЕДИНИТЬ ВСЕ
		|
		|ВЫБРАТЬ
		...
		Запрос.УстановитьПараметр("ВсеРодителиВидаДокумента", ВсеРодителиВидаДокумента);
