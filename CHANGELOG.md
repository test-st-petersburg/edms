...
- в конфигурации
  ...
  - через расширение ДокументооборотКОРП_ПоискИУдалениеДублейВПолныхРолях:

    - добавлены команды `ОбъединитьВыделенные` и `ПоказатьМестаИспользования`
      в форму списка полных ролей.
    - добавлена форма выбора в справочник `ПолныеРоли`.
