...
- в конфигурации
  ...
  - через расширение ДокументооборотКОРП_ДополнительныеОбработчикиДляПроцессов:
    ...
    - `ИТГ_СтроковыеФункцииКлиентСервер.РегистрНачатьСЗаглавной`
    - `ИТГ_СтроковыеФункцииКлиентСервер.РегистрНачатьНеСЗаглавной`
...
- в конфигурации
  ...
  - через расширение ДокументооборотКОРП_ДополнительныеОбработчикиДляПроцессов:
    ...
    - добавлено получение свойства "Подразделение" (для получения подразделения работника
      в должностной инструкции):
      `ИТГ_УправлениеСвойствами.ПолучитьЗначениеСвойства_ПодразделениеРаботника`
